...
Version  : 3.11.6
Release  : 1
URL      : http://pypi.debian.net/icalendar/icalendar-3.11.6.tar.gz
Source0  : http://pypi.debian.net/icalendar/icalendar-3.11.6.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1502838487
