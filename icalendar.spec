...
Source0  : https://files.pythonhosted.org/packages/e4/dd/67c363b99c4384c66bcf94c1abf9b749dd4e809a44bd6db575ec8e22be89/icalendar-4.0.6.tar.gz
...
%prep
%setup -q -n icalendar-4.0.6
cd %{_builddir}/icalendar-4.0.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1588871017
...
cp %{_builddir}/icalendar-4.0.6/LICENSE.rst %{buildroot}/usr/share/package-licenses/icalendar/2615805ee0a7d616a284264feb385df7f0791482
