...
Version  : 4.0.5
Release  : 30
URL      : https://files.pythonhosted.org/packages/4b/54/f9af7a0a11610e236d372659e4bf8775bd6dd1eb56863fa01c25fba84612/icalendar-4.0.5.tar.gz
Source0  : https://files.pythonhosted.org/packages/4b/54/f9af7a0a11610e236d372659e4bf8775bd6dd1eb56863fa01c25fba84612/icalendar-4.0.5.tar.gz
...
%prep
%setup -q -n icalendar-4.0.5
cd %{_builddir}/icalendar-4.0.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1584891796
...
cp %{_builddir}/icalendar-4.0.5/LICENSE.rst %{buildroot}/usr/share/package-licenses/icalendar/2615805ee0a7d616a284264feb385df7f0791482
